        ...
        {cards.map((card) => {
          return (
            ...
            >
              ...
              <Box color="#E1D3C1" fontSize={20} fontWeight={500} mt={20}>
                Абонентская плата
              </Box>
              <Box
                my={4}
                ...
                minWidth={202}
                borderRadius={20}
                boxShadow="-6px -12px 20px rgba(95, 79, 151, 0.26), 10px 12px 20px rgba(48, 35, 94, 0.37)"
              >
                {card.price}
              </Box>
              <Box color="#E1D3C1" fontSize={20} fontWeight={500}>
                Комиссия с прибыли
              </Box>
              <Box
                my={4}
